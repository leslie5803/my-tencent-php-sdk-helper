...
namespace TencentHelper\Nlp;

use TencentCloud\Nlp\V20190408\Models\{AutoSummarizationRequest,KeywordsExtractionRequest,TextCorrectionRequest};
use TencentHelper\AbstractNlp;
